function UserProfile() {
    return (
      ...
      hover:shadow-xl">
        <img className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto hover:scale-110
        ...
        <p className="text-gray-600 hover:text-blue-500 sm:text-sm md:text-base">
